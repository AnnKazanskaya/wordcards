...
window.DICT = {
  ...
  // слова из диалогов
  actually: "вообще-то; на самом деле", add: "добавлять", again: "снова", any: "какой-нибудь; любой",
  anything: "что-нибудь", away: "прочь; take away — с собой", bit: "немного; a bit — чуть-чуть",
  black: "чёрный", blue: "синий", card: "карта (банковская)", cash: "наличные", cheap: "дешёвый",
  cough: "кашель", couple: "пара; a couple of — пара, несколько", doctor: "врач", "don't": "не (do not)",
  enjoy: "наслаждаться; enjoy! — приятного!", exactly: "именно; точно", expensive: "дорогой",
  fever: "температура; жар", fifteen: "пятнадцать", fifty: "пятьдесят", fine: "в порядке; хорошо",
  fit: "подходить (по размеру)", fitting: "примерочная (fitting room)", forty: "сорок", four: "четыре",
  fresh: "свежий", friendly: "дружелюбный", great: "отлично; замечательный", head: "голова",
  headache: "головная боль", hello: "здравствуйте", hi: "привет", hmm: "хм", hurt: "болеть; причинять боль",
  "i'll": "я буду (I will)", "i'm": "я (I am)", if: "если", ill: "больной", jacket: "куртка", just: "просто; только",
  large: "большой", let: "позволять; let me — давайте я", "let's": "давай(те)", lot: "много (a lot of)",
  mean: "значить; иметь в виду", medicine: "лекарство", medium: "средний (размер M)", mint: "мята",
  minute: "минута", nine: "девять", off: "выкл.; скидка (20% off)", ok: "хорошо", over: "над; over there — вон там",
  past: "после; half past nine — половина десятого", peak: "пик; off-peak — вне часа пик", percent: "процент",
  platform: "платформа", point: "точка (в числах — запятая)", polite: "вежливый", problem: "проблема",
  ready: "готовый", receipt: "чек", regular: "обычный", rest: "отдыхать", return: "возвращаться; билет туда-обратно",
  sale: "распродажа", seem: "казаться", serious: "серьёзный", sign: "знак; указатель", since: "с (какого-то времени)",
  single: "один; билет в одну сторону", size: "размер", soon: "скоро", sore: "больной; sore throat — больное горло",
  sorry: "извините", sound: "звучать; звук", tablet: "таблетка", temperature: "температура", thirty: "тридцать",
  throat: "горло", ticket: "билет", tight: "тесный; узкий", time: "время; раз", tip: "совет; чаевые",
  travel: "путешествовать; ехать", try: "пробовать; примерять", turn: "поворачивать", twice: "дважды",
  way: "путь; способ", wear: "носить (одежду)", well: "хорошо; здоровый", what: "что", "what's": "что (what is)",
  which: "который", would: "бы; would like — хотел бы", wrong: "неправильный; what's wrong — что случилось",
  "you'll": "ты будешь (you will)",
  // слова из книги «The Little Prince»
  abandon: "бросать; оставлять", absurd: "абсурдный", acquaintance: "знакомство", adventure: "приключение",
  advise: "советовать", age: "возраст", all: "все; весь", already: "уже", among: "среди", another: "другой; ещё один",
  anxious: "тревожный; нетерпеливый", apologize: "извиняться", arizona: "Аризона (штат США)", apparition: "видение; призрак", appearance: "внешность",
  aside: "в сторону", astonishment: "изумление", astound: "поражать", astray: "сбившийся с пути",
  attentive: "внимательный", attentively: "внимательно", beast: "зверь", become: "становиться", became: "стал",
  been: "был (have been)", begin: "начинать", began: "начал", boa: "удав", breakdown: "поломка", bridge: "мост; бридж (игра)",
  calculation: "арифметика; вычисление", capable: "способный", career: "карьера", castaway: "потерпевший кораблекрушение",
  chew: "жевать", child: "ребёнок", children: "дети", china: "Китай", color: "цвет; раскрашивать", colour: "цвет",
  comfort: "утешать", constrictor: "удав (boa constrictor)", contact: "контакт; общение", copy: "копия",
  correct: "исправлять; правильный", country: "страна; местность", cumbersome: "громоздкий", danger: "опасность",
  dangerous: "опасный", dare: "сметь; осмеливаться", dawn: "рассвет", dead: "мёртвый", death: "смерть",
  dedicate: "посвящать", dedication: "посвящение", desert: "пустыня", difficult: "трудный", digest: "переваривать",
  digestion: "пищеварение", discourage: "отбивать охоту; обескураживать", dismantle: "разбирать (механизм)",
  dismantling: "разборка", disobey: "ослушаться", draw: "рисовать", drew: "нарисовал", drawn: "нарисованный",
  drawing: "рисунок", during: "во время", elephant: "слон", engine: "двигатель", except: "кроме",
  explanation: "объяснение", extraordinary: "необыкновенный", eye: "глаз", failure: "неудача", fatigue: "усталость",
  fault: "вина", fear: "страх", feet: "ноги (ступни)", foot: "нога (ступня)", fellow: "парень; малый", final: "последний",
  finally: "наконец", fly: "летать", flew: "летел", forest: "лес", france: "Франция", frighten: "пугать",
  full: "полный", funny: "забавный; странный", gentle: "мягкий; нежный", gently: "мягко; нежно", geography: "география",
  glad: "рад", glance: "взгляд; at first glance — с первого взгляда", golf: "гольф", gone: "ушедший (go)",
  grammar: "грамматика", grave: "серьёзный", gravely: "серьёзно", grown: "выросший; grown-up — взрослый",
  hard: "трудный; твёрдый", hardly: "едва; почти не", hat: "шляпа", hear: "слышать", heard: "слышал",
  hein: "а?; что? (фр.)", history: "история", horn: "рог", humor: "настроение; юмор", hunger: "голод",
  hungry: "голодный", ii: "два (римская цифра)", illuminate: "озарять; освещать", imagine: "представлять",
  impressive: "впечатляющий", improve: "улучшать", indulgent: "снисходительный", indulgently: "снисходительно",
  inhabit: "населять", inhabited: "обитаемый", instead: "вместо", interest: "интересоваться; интерес",
  isolate: "изолировать", isolated: "одинокий; изолированный", jump: "прыгать", jungle: "джунгли", lack: "нехватка",
  land: "земля; суша", lean: "наклоняться", leon: "Леон (имя)", less: "меньше", lightning: "молния", lucid: "ясно мыслящий",
  magnificent: "великолепный", manage: "суметь; справиться", masterpiece: "шедевр", matter: "дело; иметь значение",
  mechanic: "механик", meet: "встречать", met: "встретил", middle: "середина", mile: "миля", model: "модель; оригинал",
  month: "месяц", myself: "себя; сам", mystery: "тайна", neither: "ни (neither… nor — ни… ни)", night: "ночь",
  nor: "ни", number: "номер; число", ocean: "океан", once: "однажды; один раз", opinion: "мнение", painter: "художник",
  paper: "бумага", passenger: "пассажир", patience: "терпение", pen: "ручка", pencil: "карандаш", politics: "политика",
  portrait: "портрет", precede: "предшествовать", preceding: "предыдущий", preserve: "сохранять", prey: "добыча",
  prince: "принц", profession: "профессия", raft: "плот", ram: "баран", ravishing: "восхитительный", reach: "досягаемость; достигать",
  real: "настоящий", really: "действительно", reasonable: "разумный", recognize: "узнавать", refuse: "отказываться",
  region: "местность; регион", repeat: "повторять", reply: "отвечать", reprieve: "отсрочка; передышка",
  require: "требовать", rub: "тереть", sahara: "Сахара", sand: "песок", scary: "страшный", scribble: "черкать; набросать",
  serve: "служить", sheep: "овца", sheet: "лист (бумаги)", six: "шесть", something: "что-то", star: "звезда",
  strike: "ударять", struck: "ударил; поражённый", study: "изучать", succeed: "преуспеть; удаться", such: "такой",
  suffice: "быть достаточным", surely: "конечно", surprise: "удивление; удивлять", swallow: "глотать",
  their: "их", thirst: "жажда", thousand: "тысяча", throw: "бросать", threw: "бросил", thus: "таким образом",
  tie: "галстук; привязывать", tiny: "крошечный", tire: "утомлять", tiring: "утомительный", toward: "к; по направлению",
  until: "до тех пор пока", useful: "полезный", virgin: "девственный; нетронутый", voice: "голос",
  wake: "будить; просыпаться", woke: "проснулся", watch: "смотреть; наблюдать", werth: "Верт (фамилия)",
  who: "кто; который", wild: "дикий", within: "в пределах", without: "без", world: "мир", written: "написанный",
  young: "молодой",
  // имена собственные
